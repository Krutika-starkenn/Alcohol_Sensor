...
volatile  WORD timer1, timer2,timeout,Uart3Timeout,UpdateAcc;
static volatile	 DSTATUS Stat = STA_NOINIT;	/* Disk status */
static BYTE CardType;

/* Private macro -------------------------------------------------------------*/
#define SD_SELECT()     GPIO_ResetBits(GPIOA, GPIO_Pin_4)       /* CS = L */ 
#define SD_DESELECT()   GPIO_SetBits(GPIOA, GPIO_Pin_4)         /* CS = H */
...
//	printf2(" Wait for enter Idle state in timeout of 5000ms\r\n");
    timer1 = 500;
    do
	{
...
//	printf2(" done\r\n");
    ...
    if(type) 
	{
        ...
        Stat &= ~STA_NOINIT;	
//				printf2(" Initialization succeded, stat=0\r\n");
    } 
    return Stat;
}
